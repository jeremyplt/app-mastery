...
export const EMAIL_LABELS: Record<string, string> = {
  ...
  "plan-action": "C0 · Ton Plan d'Action est prêt",
  "seq-c-1": "C1 · Pourquoi Shinobi a marché dès le premier mois",
  "seq-c-2": "C2 · Le code n'a jamais été ton problème",
  "seq-c-3": "C3 · Comment valider ton idée d'app en 48 heures",
  "seq-c-4": "C4 · Des millions de vues sans un euro de pub",
  "seq-c-5": "C5 · Le modèle de prix qui convertit le mieux",
...
export const FLOWS: Flow[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { tag: "seq-c-1", label: "C1", subject: "{prénom}, pourquoi Shinobi a marché dès le premier mois", when: "J1 · 9 h", status: "live" },
      { tag: "seq-c-2", label: "C2", subject: "Le code n'a jamais été ton problème", when: "J2 · 9 h", status: "live" },
      { tag: "seq-c-3", label: "C3", subject: "Comment valider ton idée d'app en 48 heures", when: "J3 · 9 h", status: "live" },
      { tag: "seq-c-4", label: "C4", subject: "{prénom}, des millions de vues sans un euro de pub", when: "J4 · 9 h", status: "live" },
      { tag: "seq-c-5", label: "C5", subject: "Le modèle de prix qui convertit le mieux", when: "J5 · 9 h", status: "live" },
      { tag: "seq-c-6", label: "C6", subject: "Ton app est sur l'App Store et il ne se passe rien", when: "J6 · 9 h", status: "live" },
      { tag: "seq-c-7", label: "C7", subject: "1 793 $ en 28 jours, sans savoir coder", when: "J7 · 9 h", status: "live", note: "Bouton vers le témoignage de Florian" },
      { tag: "seq-c-8", label: "C8", subject: "{prénom}, mon dernier email, et une mauvaise nouvelle", when: "J8 · 9 h", status: "live" },
    ],
  },
  {
    id: "appel",
