  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white antialiased">
      <div className="mx-auto max-w-2xl px-6 py-20">
        ...
        {/* WhatsApp CTA */}
        <div className="mb-10 isolate overflow-hidden rounded-2xl bg-gray-950 p-2 outline outline-green-500/20">
          <div className="relative rounded-xl bg-white/5 p-6 sm:p-8 overflow-hidden">
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5">
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 rounded-full bg-green-500 px-6 py-3 text-base font-bold text-white hover:bg-green-400 transition-colors shadow-lg shadow-green-500/25 shrink-0"
              >
                <svg
                  className="w-5 h-5"
                  viewBox="0 0 24 24"
