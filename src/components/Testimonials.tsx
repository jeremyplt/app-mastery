    ...
    <section className="relative py-20">
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="mb-8 flex items-center gap-4">
          <span className="mac-eyebrow">Résultats</span>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
          {testimonials.map((t, i) => (
            <motion.div
              key={i}
              className="relative overflow-hidden rounded-[16px] border-[0.5px] border-[var(--sep)] bg-[var(--card)] p-5"
            ...
            >
              ...
              <div className="mb-3">
                ...
                <div className="text-sm text-[var(--fg2)] font-medium">
                  {t.role}
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 mb-3 text-sm">
                <span className="text-[var(--fg3)] line-through">
                  {t.before}
                </span>
              ...
              {/* Stars */}
              <div className="flex text-[var(--orange)] gap-0.5 mb-3">
                {[...Array(5)].map((_, j) => (
                  <svg
                    key={j}
              ...
              {/* Quote */}
              <p className="text-lg/8 text-[var(--fg2)]">
                &ldquo;{t.text}&rdquo;
              </p>
            </motion.div>
          ))}
        ...
        >
          {expired ? (
            <span className="mac-btn mac-btn-def opacity-50 cursor-not-allowed">
              Inscription fermée
            </span>
          ) : (
            <a
