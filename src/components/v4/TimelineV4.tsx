...
const steps = [
  ...
  },
  {
    week: "Sem. 3",
    title: "Publication",
    desc: "Publie sur l'App Store et le Google Play Store.",
    icon: Rocket,
        ...
        <div className="flex flex-col items-center gap-0 lg:hidden">
          {steps.map((step, i) => (
            ...
            >
              ...
              <span className="mt-1 text-sm text-gray-400 max-w-xs">
                {step.desc}
              </span>
            </motion.div>
          ))}
        ...
        <div className="hidden lg:grid grid-cols-4 gap-0 items-start">
          {steps.map((step, i) => (
            ...
            >
              ...
              <span className="mt-1 text-xs text-gray-400 max-w-[180px]">
                {step.desc}
              </span>
            </motion.div>
          ))}
